...
class MusicHandlerBase(ABC):
    ...
    async def get_url(self, query: str) -> str:
        ...
        raise NotImplementedError(
            'Custom exception must have \'get_url\' method.')
    ...
    async def get_urls(self, query: str, max_results: int = 5) -> list[str]:
        ...
        """
        raise NotImplementedError(
            'Custom exception must have \'get_urls\' method.')
    ...
    async def get_metas(self, query: str, max_results: int = 5) -> list[Track]:
        ...
        """
        raise NotImplementedError(
            'Custom exception must have \'get_metas\' method.')
    ...
    async def get_metadata(self, query: str, is_url: bool = False) -> tuple[Track]:
        ...
        """
        raise NotImplementedError(
            'Custom exception must have \'get_metadata\' method.')
    ...
    async def get_stream(self, url: str) -> str:
        ...
        """
        raise NotImplementedError(
            'Custom exception must have \'get_stream\' method.')
...
class CustomException(commands.CommandError, ABC):
    ...
    def description(self) -> str:
        raise NotImplementedError(
            'Custom exception must have \'description\' property.')

    @abstractproperty
    def type_(self) -> str:
        raise NotImplementedError(
            'Custom exception must have \'type_\' property.')
